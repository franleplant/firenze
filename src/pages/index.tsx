...
const tweets: tweet[] = [
	...
	{ author: "Toto 10", content: "First Content 10", date: "2hrs ago", id: "10" },
	{ author: "Toto 11", content: "First Content 11", date: "2hrs ago", id: "11" },
	{ author: "Toto 12", content: "First Content 12", date: "2hrs ago", id: "12" },
	...
	{ author: "Toto 19", content: "First Content 19", date: "2hrs ago", id: "19" },
];
...
const Home: NextPage = () => {
	return (
		<>
			<Meta title={"Firenze"} />
			<main className='relative flex flex-col sm:ml-10 border-gray-500 sm:w-3/5 sm:border-l sm:border-r'>
				<nav className='hidden sm:block bg-black text-gray-200 sticky top-0 py-2 px-4'>
					<div className='hover:text-white'>
						<Link href='/'>Home</Link>
					</div>
				</nav>
				<section className='px-4 sm:px-0 divide-y divide-yellow-600'>
