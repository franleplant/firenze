import ethereumLogoUrl from "./ethereum-logo.png";
import arbitrumLogoUrl from "./arbitrum_logo.svg";
import optimismLogoUrl from "./optimistic_ethereum.svg";
...
export const CHAIN_INFO: ChainInfo = {
  [SupportedChainId.ARBITRUM_ONE]: {
    blockWaitMsBeforeWarning: 10 * 60 * 1000,
